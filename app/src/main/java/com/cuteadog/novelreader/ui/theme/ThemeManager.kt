    ...
    companion object {
        ...
        fun forTheme(theme: Int): ThemePalette = when (theme) {
            ...
            ThemeManager.THEME_NIGHT -> ThemePalette(
                ...
                surfaceBg = Color.parseColor("#202020"),
                groupBg = Color.parseColor("#1A1A1A"),
                textPrimary = Color.parseColor("#80808D"),
                textSecondary = Color.parseColor("#606067"),
                titleBarBg = Color.parseColor("#2C2C2C"),       // 废除 #445566
                titleBarFg = Color.parseColor("#80808D"),
                dividerColor = Color.parseColor("#404040"),
                buttonBg = Color.parseColor("#2C2C2C"),
                buttonFg = Color.parseColor("#80808D"),
                ...
                titleBarBg = Color.parseColor("#F3F3F3"),   // 废除 #4DABF5 / #2196F3
                titleBarFg = Color.parseColor("#212121"),
                dividerColor = Color.parseColor("#E0E0E0"),
                buttonBg = Color.parseColor("#F3F3F3"),
                buttonFg = Color.parseColor("#212121"),
                popupBg = Color.parseColor("#DD1A1A2E"),
                popupFg = Color.parseColor("#FFFFFF"),
