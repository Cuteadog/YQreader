package com.cuteadog.novelreader.service
...
class ImportWorker(
    ...
    companion object {
        // 导入相关常量
        const val ACTION_IMPORT_STARTED = "com.cuteadog.novelreader.ACTION_IMPORT_STARTED"
        const val ACTION_IMPORT_PROGRESS = "com.cuteadog.novelreader.ACTION_IMPORT_PROGRESS"
        const val ACTION_IMPORT_COMPLETED = "com.cuteadog.novelreader.ACTION_IMPORT_COMPLETED"
        const val ACTION_IMPORT_ERROR = "com.cuteadog.novelreader.ACTION_IMPORT_ERROR"

        const val EXTRA_PROGRESS = "com.cuteadog.novelreader.EXTRA_PROGRESS"
        const val EXTRA_ERROR = "com.cuteadog.novelreader.EXTRA_ERROR"

        const val EXTRA_FOLDER_URI = "com.cuteadog.novelreader.EXTRA_FOLDER_URI"
        const val EXTRA_NOVELS_DIR = "com.cuteadog.novelreader.EXTRA_NOVELS_DIR"
